...
# ✅ Checksum addresses
ROUTER_CONTRACT_ADDRESS = Web3.to_checksum_address("0xfb8e1c3b833f9e67a71c859a132cf783b645e436")

# Tokens (testnet USDT, USDC, WBTC, WETH)
TOKEN_A = Web3.to_checksum_address("0x88b8E2161DEDC77EF4ab7585569D2415a1C1055D")  # USDT
TOKEN_B = Web3.to_checksum_address("0xf817257fed379853cDe0fa4F97AB987181B1E5Ea")  # USDC
TOKEN_C = Web3.to_checksum_address("0xcf5a6076cfa32686c0Df13aBaDa2b40dec133F1d")  # WBTC
TOKEN_D = Web3.to_checksum_address("0xB5a30b0FDc5EA94A52fDc42e3E9760Cb8449Fb37")  # WETH
    ...
    try:
        ...
        for cycle in range(10):
            ...
            for path in SWAP_PATHS:
                ...
                signed = acct.sign_transaction(tx)
                txh = web3.eth.send_raw_transaction(signed.raw_transaction)
